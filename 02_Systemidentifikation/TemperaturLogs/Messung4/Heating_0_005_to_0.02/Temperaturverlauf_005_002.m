...
filename = 'Matlab_0_005_to_0_02.xlsx';
sheet = 1;
fileende=84000;
Zeitende=fileende/2;
xlRange = 'A:E';
[num,txt,raw] = xlsread(filename,sheet,xlRange);
t= num(1:fileende,1); T_Zelle=num(1:fileende,2); T_Mantel=num(1:fileende,3); T_Umgebung=num(1:fileende,4); u= num(1:fileende,5);
%t= num(1:end,1); u= num(1:end,5); T_Zelle=num(1:end,2); T_Mantel=num(1:end,3); T_Umgebung=num(1:end,4);
dT= T_Mantel(end:end)-T_Mantel(1:1);
%%
%In einem Plot
close all
figure('Name','Zelle');
